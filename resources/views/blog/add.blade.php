                        ...
                        <div class="card-body">
                            <form action="{{ route('blog.getData') }}" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="hidden" id="iidd" name="id" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="at">author</label>
                                    <input type="text" id="at" name="author" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="tl">title</label>
                                    <input type="text" id="tl" name="title" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="bd">body</label>
                                    <textarea name="body" id="bd" cols="30" rows="2"></textarea>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="key">keyword</label>
                                    <input type="text" id="key" name="keyword" class="form-control">
                                </div>
